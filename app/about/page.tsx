  ...
  return (
    <main>
      <div className="mx-7 py-12 max-w-[800px] xl:m-0 lg:w-[55vw] 2xl:w-[50vw] lg:max-w-[1100px] xl:p-32 overflow-auto xl:box-border">
        <div>
          <div
            className="uppercase tracking-widest text-sm mb-12 xl:mb-20 xl:mt-16"
        ...
        <div className="mt-10 flex">
          <DatoImage fragment={aboutPage.signature.responsiveImage} />
        </div>
      </div>
      <div className="hidden xl:block fixed inset-0 left-auto w-[45vw] 2xl:w-[50vw]">
        <DatoImage
          ...
          objectFit="cover"
          objectPosition={`left ${aboutPage.image.focalPoint.x * 100}% top ${
            aboutPage.image.focalPoint.y * 100
          }%`}
          sizes="50vw"
        />
      </div>
